        ...
        <div className="col-span-1 p-4 bg-black text-white">
          <div className="lg:inline flex">
                  ...
                  <div className="lg:flex lg:flex-col mt-10 hidden text-center">
                    <div className="flex justify-center mt-8">
                      <img
                        src={avatar}
                        alt="user"
                        className="h-16 w-16 bg-black rounded-full"
                      />
                    </div>
            ...
            <ul className="lg:flex lg:flex-col mt-10 hidden text-center">
              <Link to="/dashboard">
                <li
                  ...
                  className={
                    active === "1"
                      ? "mb-4 flex px-5 py-3 cursor-pointer text-2xl hover:bg-black hover:rounded-md bg-black rounded-md"
                      : "mb-4 flex px-5 py-3 cursor-pointer text-2xl hover:bg-black hover:rounded-md transition delay-100"
                  }
                >
                  <span className="mr-3">
                    <svg
            ...
            <div className="lg:hidden flex">
              <button
                className="ml-32 bg-white rounded-lg "
            ...
            <ul className="">
              ...
              <Link to="/dashboard">
                <li
                  ...
                  className={
                    active === "1"
                      ? "text-white flex text-2xl p-2 pt-8"
                      : "text-white  w-fit  flex text-2xl  pt-8"
                  }
                >
                  <span className="mx-4">
                    <svg
              ...
              <Link to="/dashboard/analysis">
                <li
                  ...
                  className={
                    active === "2"
                      ? "text-white flex text-2xl p-2 pt-4"
                      : "text-white flex text-2xl p-2 pt-4"
                  }
                >
                  <span className="mx-4">
              ...
              <div className="ml-6  mt-4 bottom-5 left-16 pb-6 ">
                <button
                  onClick={handleLogOut}
                  className="bg-white px-4 py-3 flex rounded-md font-bold w-40"
                >
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
